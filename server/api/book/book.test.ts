...
describe('Book API', () => {
    ...
    before(async(t) => {
        ...
        const res = await utils.testSetup()
        userIds = res.userIds
        tokens = res.tokens
    ...
    describe('POST /api/books', () => {
        ...
        it('should create a new book', async(t) => {
            ...
            const book = await utils.getBook(tokens[0], res.body)
    ...
    describe('PUT /api/books', () => {
        ...
        it('should return an error if user is NOT owner or editor', async(t) => {
            ...
            t.assert.notEqual(res.statusCode, 200)
            const book = await utils.getBook(tokens[0], myBook._id)
        ...
        it('should return a success if user is an editor', async(t) => {
            ...
            const serverBook = await utils.getBook(tokens[1], myBook._id)
        ...
        it('should return an error if a user other than the owner tries to change the owner', async(t) => {
            ...
            const res = await server.inject()
                ...
                .body(myBook)
            t.assert.notEqual(res.statusCode, 200)
            const serverBook = await utils.getBook(tokens[0], myBook._id)
