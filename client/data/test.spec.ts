    ...
    describe("joinRoom function", () => {
        ...
        it("should get a connection and emit the input on channel 'join'", done => {
            ...
            .then(() => {
                ...
                expect(emitSpy.calledWith("join", room)).to.be.true;
                done()
            })
        })
    })
...
describe("Base Reducer", () => {
    ...
    describe("addedOrChanged function", () => {
        xit("should add all items to the list that do NOT already exist", () => {})

        xit("should update all items to the list that already exist", () => {})
