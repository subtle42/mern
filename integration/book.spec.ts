...
const MONGOURI = "mongodb://localhost/merntest"
...
describe("Book API", () => {
    ...
    describe("PUT /api/books", () => {
        ...
        before(done => {
            utils.createBook(App.express, tokens[0], "update book test")
            .then(id => bookId = id)
            .then(() => done())
        })
    ...
    describe("DELETE /api/books", () => {
        ...
        before(done => {
            ...
            utils.createBook(App.express, tokens[0], "to delete")
        ...
        it("should broadcast the id of the deleted item", done => {
            ...
            utils.createBook(App.express, tokens[0], "testinglkwe")
            .then(secondBookId => {
                return chai.request(App.express)
                .del(`/api/books/${myBookID}`)
                .set("Authorization", tokens[0])
